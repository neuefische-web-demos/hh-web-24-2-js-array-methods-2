...
const stringToCheck = "styled components";
const stringIsIncluded = strings.includes(stringToCheck);
stringOutput.textContent = stringIsIncluded ? `Yes, string ${stringToCheck} is included.` : `No, string ${stringToCheck} is not included.`;

const objectToFind = simpsons.find((item) => item.age === 15);
